...
const Checkout = () => {
  return (
    ...
    <div className="cart3 bg-white border-[#e72b70] xl:w-[40%] xl:ml-[8%] xl:py-4 sm:w-[85%]  sm:mt-4 sm:py-3 rounded-[15px]">
        <p className='text-[#CA2F69] text-2xl ml-[6%]'>Cart(3)</p>   
    </div>
    <div className="shooping bg-white border-[#CA2F69] border-x-[#CA2F69] xl:w-[40%] xl:ml-[8%] xl:mt-1 xl:py-6 xl:px-5 rounded-[9px] flex">
    <i className="ri-shopping-cart-line absolute xl:ml-[34%] sm:ml-[90%] text-[#CA2F69]"></i>
        ...
        <div className="shooping bg-white border-[#CA2F69] ] xl:w-[40%] xl:ml-[8%] xl:mt-[2%] xl:py-6 xl:px-5 rounded-[9px] flex">
        <i className="ri-shopping-cart-line absolute xl:ml-[34%] sm:ml-[90%] text-[#CA2F69]"></i>
        ...
        <div className="shooping bg-white border-[#CA2F69] border-x-[#CA2F69] xl:w-[40%] xl:ml-[8%] xl:mt-[2%] xl:py-6  xl:px-5 rounded-[9px] flex ">
        <i className="ri-shopping-cart-line absolute xl:ml-[34%] sm:ml-[90%] text-[#CA2F69]"></i>
