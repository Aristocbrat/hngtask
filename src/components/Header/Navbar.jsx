...
<div className="f bg-[#CA2F69] py-4">
  <p className='text-white flex justify-center sm:justify-start sm:ml-[20%] md:ml-[25%] lg:ml-[35%] xl:ml-[40%] px-4 sm:px-6 md:px-8'>
    Nationwide delivery
    ...
    <div className='flex items-center justify-between w-full py-1 px-4 md:px-[6%]'>
      ...
      <a href="/"><img src="/images/logo.png" alt="logo"  className="md:w-[180px] xl:w-[130px] sm:w-[100px]" /></a>
      <div className='bg-slate-100 flex items-center py-1 px-2 rounded-[20px]'>
        <input type="text" placeholder="Search" className="placeholder:text-sm xl:w-[200px] sm:w-[150px] md:min-w-[400px] text-zinc-700 font-bold bg-transparent outline-none border-none" />
      ...
      <div className='flex items-center gap-4 text-white'>
        ...
        <a href="/Home" className='xl:text-[12px] sm:text-[7px] '>Shop</a>
      </div>
    </div>
    </>
  );
